...
class StaticTFBroadcaster(Node):
    def __init__(self):
        super().__init__("testbed_static_tf")

        # ---- Params (match simulation_bringup/sim_static_tf) ----
        ...
        # Camera mount translation (base -> camera_link)
        self.declare_parameter("cam_x", 0.0)
        self.declare_parameter("cam_y", 0.0)
        self.declare_parameter("cam_z", 0.2)
        # Camera optical rotation (camera_link -> camera_optical_frame)
